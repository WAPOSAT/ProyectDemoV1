...
class processBlock1 {
    ...
    public function getProcessBlock ($idUser,$idBlock){
        $sql = "SELECT * FROM Blocks,Users_Blocks WHERE Users_Blocks.id_block=Blocks.id_block AND Blocks.id_block_type=1 AND Users_Blocks.id_user='".$idUser."' AND Blocks.id_block=".$idBlock." LIMIT 1";
    ...
    public function getSensors4 ($idBlock){
        $sql = "SELECT * FROM Sensors,Block_Sensors WHERE Block_Sensors.id_sensor=Sensors.id_sensor AND Block_Sensors.id_block=".$idBlock." LIMIT 4 ";
        $this->_conexion->ejecutar_sentencia($sql);
    }
