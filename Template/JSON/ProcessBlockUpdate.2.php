...
While($PB1 = $si1->retornar_SELECT()){
    ...
    While($PB2 = $si1b->retornar_SELECT()){
        ...
        $new2 = array('Id'=>$PB2["id_sensor"], 'LMP'=>$PB2["up_danger_limit"], 'LMR'=>$PB2["up_risk_limit"],  'LastValue'=>$last["value"], 'LastDate'=>$last["date"] );
    ...
    $new = array('Id'=>$PB1["id_block"], 'Sensor'=>$Sensor );
    array_push($StationBlock, $new);
}

$StaticInfo = array('Id'=>$ProcessBlock["id_block"], 'StationBlock'=>$StationBlock, 'Danger'=>$Danger, 'Risk'=>$Risk);
